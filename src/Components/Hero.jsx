    ...
    useGSAP(
        () => {
            gsap.set('#video-frame', {
                clipPath: 'polygon(12% 0%, 71% 0%, 90% 90%, 0% 100%)',
                ...
                <div>
                    <div className='mask-clip-path absolute-center absolute z-50 size-64 cursor-pointer overflow-hidden rounded-lg'>
                        <div onClick={handleMiniVidClick}
                            ...
                            <video
                                ref={nextVidRef}
                                src={getVideoSrc(upcomingVidIndex)}
                                loop
                                muted
                                id="current-video"
                ...
                <div className='absolute left-0 top-0 z-40 size-full'>
                    <div className='mt-24 px-5 sm:px-10'>
                        <h1 className='special-font hero-heading text-blue-100'>
                            L<b>e</b>v<b>e</b>l</h1>
                        <p className='mb-5 max-w-64 font-robert-regular text-blue-100'>
                            Master Every Level, <br />
                            Conquer Every Game
                        </p>
                        <Buttons id="watch-trailer" title="Watch Trailer" leftIcon={<TiLocationArrow />}
